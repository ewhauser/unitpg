...
extern PGDLLEXPORT FastPgRewriteResult *fastpg_parser_rewrite(FastPgAnalyzeResult *analyze_result);
extern PGDLLEXPORT void fastpg_rewrite_result_free(FastPgRewriteResult *result);

extern PGDLLEXPORT bool fastpg_rewrite_result_ok(const FastPgRewriteResult *result);
extern PGDLLEXPORT const char *fastpg_rewrite_error_sqlstate(const FastPgRewriteResult *result);
extern PGDLLEXPORT const char *fastpg_rewrite_error_message(const FastPgRewriteResult *result);
extern PGDLLEXPORT int fastpg_rewrite_error_cursorpos(const FastPgRewriteResult *result);

extern PGDLLEXPORT int fastpg_rewrite_query_count(const FastPgRewriteResult *result);
extern PGDLLEXPORT const char *fastpg_rewrite_query_command_tag(const FastPgRewriteResult *result,
																int index);
extern PGDLLEXPORT bool fastpg_rewrite_query_is_utility(const FastPgRewriteResult *result,
														int index);
extern PGDLLEXPORT const char *fastpg_rewrite_query_utility_stmt_tag(const FastPgRewriteResult *result,
																	 int index);
extern PGDLLEXPORT int fastpg_rewrite_query_target_count(const FastPgRewriteResult *result,
														 int index);

extern PGDLLEXPORT FastPgPlanResult *fastpg_parser_plan(FastPgRewriteResult *rewrite_result);
extern PGDLLEXPORT void fastpg_plan_result_free(FastPgPlanResult *result);

extern PGDLLEXPORT bool fastpg_plan_result_ok(const FastPgPlanResult *result);
extern PGDLLEXPORT const char *fastpg_plan_error_sqlstate(const FastPgPlanResult *result);
extern PGDLLEXPORT const char *fastpg_plan_error_message(const FastPgPlanResult *result);
extern PGDLLEXPORT int fastpg_plan_error_cursorpos(const FastPgPlanResult *result);

extern PGDLLEXPORT int fastpg_plan_statement_count(const FastPgPlanResult *result);
extern PGDLLEXPORT const char *fastpg_plan_statement_command_tag(const FastPgPlanResult *result,
																 int index);
extern PGDLLEXPORT const char *fastpg_plan_statement_plan_tree_tag(const FastPgPlanResult *result,
																   int index);
extern PGDLLEXPORT const char *fastpg_plan_statement_utility_stmt_tag(const FastPgPlanResult *result,
																	  int index);
extern PGDLLEXPORT int fastpg_plan_statement_target_count(const FastPgPlanResult *result,
														  int index);
