...
static _Thread_local HTAB *seq_scan_tables[MAX_SEQ_SCANS]; /* tables being scanned */
static _Thread_local int seq_scan_level[MAX_SEQ_SCANS];	/* subtransaction nest level */
static _Thread_local int num_seq_scans = 0;
