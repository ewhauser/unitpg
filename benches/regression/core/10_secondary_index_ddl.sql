...
CREATE INDEX fastpg_reg_secondary_index_gist ON fastpg_reg_secondary_index USING gist (to_tsvector('simple', body));
CREATE INDEX fastpg_reg_secondary_index_spgist ON fastpg_reg_secondary_index USING spgist (code);
CREATE INDEX fastpg_reg_secondary_index_gin ON fastpg_reg_secondary_index USING gin (to_tsvector('simple', body));
